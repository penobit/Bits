...
<body>
    <div class="container">
        <div class="error">
            ...
            <h2><?= $description;?></h2>
            <p><?= $message;?></p>
            <pre style="max-width: 100%; overflow: auto"><?= $trace;?></pre>
        </div>
            ...
            if (e.animationName === 'explode') {
                cardNodes.forEach(function(elem, index) {
                    ...
                    elem.addEventListener('click', function() {
                        ...
                        let $lastCard = cardNodes[counter - 1];
                        $lastCard.style.transform = `translate(${randomX}px, ${randomY}px) rotate(-540deg)`
                        $lastCard.style.transition = "transform 1s ease, opacity 2s";
