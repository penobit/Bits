...
<main class="content">
	<div class="container-fluid p-0">
				...
				<div class="w-100">
					<div class="row">
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title mb-4">تعداد حساب کاربری</h5>
									<h1 class="mt-1 mb-3">2</h1>
									<div class="mb-1">
										<span class="text-success">
											<i class="mdi mdi-arrow-bottom-right"></i> +3.65% </span>
										<span class="text-muted">رشد</span>
									</div>
								</div>
							</div>
							<div class="card">
								<div class="card-body">
									<h5 class="card-title mb-4">پست های در صف</h5>
									<h1 class="mt-1 mb-3">14</h1>
									<div class="mb-1">
										<span class="text-success">
											<i class="mdi mdi-arrow-bottom-right"></i> +4 </span>
										<span class="text-muted">استوری</span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title mb-4">انقضا سرویس</h5>
									<h1 class="mt-1 mb-3">1399/9/19</h1>
									<div class="mb-1">
										<span class="text-success">
											<i class="mdi mdi-arrow-bottom-right"></i> 10 </span>
										<span class="text-muted">روز دیگر</span>
									</div>
								</div>
							</div>
							<div class="card">
								<div class="card-body">
									<h5 class="card-title mb-4">کل پست های ارسالی</h5>
									<h1 class="mt-1 mb-3">64</h1>
									<div class="mb-1">
										<span class="text-danger">
											<i class="mdi mdi-arrow-bottom-right"></i> -2.25% </span>
										<span class="text-muted">در هفته گذشته</span>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="col-xl-6 col-xxl-7">
				<div class="card flex-fill w-100">
					<div class="card-header">
						...
						<h5 class="card-title mb-0">نمودار پست های ارسالی هفته گدشته</h5>
					</div>
		...
		<div class="row">
			<div class="col-12 col-md-6 d-flex order-2 order-xxl-2">
				<div class="card flex-fill w-100">
					<div class="card-header">

						<h5 class="card-title mb-0">لورم ایپسوم</h5>
					</div>
			...
			<div class="col-12 col-md-6 d-flex order-1 order-xxl-1">
				<div class="card flex-fill">
					<div class="card-header">
						...
						<h5 class="card-title mb-0">تقویم محتوا</h5>
					</div>
					<div class="card-body d-flex">
						<div class="align-self-center w-100">
							<div class="chart">
