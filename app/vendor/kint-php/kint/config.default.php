 ...
 *
 * Defaults to array( $_SERVER['DOCUMENT_ROOT'] => '&lt;ROOT_PATH&gt;' )
 *
 * [!] EXAMPLE (for Kohana framework):
 *
 * $_kintSettings['appRootDirs'] = array(
 *      APP_PATH => 'APP_PATH', // make sure the constants are already defined at the time of including this config file
 *      SYSPATH => 'SYSPATH',
 *      MODPATH => 'MODPATH',
 *      DOCROOT => 'DOCROOT',
 * );
 ...
 *
 * $_kintSettings['appRootDirs'] = array(
 *      realpath( __DIR__ . '/../../..' ) => 'ROOT_PATH', // go up as many levels as needed in the realpath() param
 * );
 *
 * $_kintSettings['fileLinkFormat'] = 'http://localhost:8091/?message=%f:%l';
 *
...
$_kintSettings['appRootDirs'] = isset( $_SERVER['DOCUMENT_ROOT'] )
	? array( $_SERVER['DOCUMENT_ROOT'] => '&lt;ROOT_PATH&gt;' )
	: array();
