...
class PropertyMapCompiler
{
        ...
        $solveClassName)
    {
        $rootCompiler = new self( // Throws.
            true, // This is the ROOT_PATH compilation call!
            $propertyMapCache,
            $solveClassName
        );
        ...
        $solveClassName)
    {
        ...
        // any resources they need. And the ROOT_PATH compiler is responsible for
        ...
        // the ABSOLUTE ROOT_PATH COMPILE-CALL which STARTED the current compilation
    ...
    private function _compile()
    {
        ...
        // absolute ROOT_PATH CALL which began the whole compilation process. If not,
